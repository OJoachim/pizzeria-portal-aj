  ...
  return (
    <Paper className={styles.component}>
      ...
      <form className={styles.form} noValidate>
        ...
        <Grid item xs={12}>
          <TextField className={styles.textField} variant="outlined" fullWidth margin="normal" id="id" label="Event id" name="id" autoComplete="id" autoFocus size="small" />
        ...
        <Button className={styles.addbtn} type="submit" fullWidth variant="contained" color="primary" component={Link} to={`${process.env.PUBLIC_URL}/tables`}>Add event</Button>
      </form>
    </Paper>
  );
};
